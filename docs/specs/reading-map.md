...
| Agent terminal (per-project Terminal/Transcript tabs; gated by its own switch, no credential) | `docs/specs/agent-terminal.md` | `crates/mdview/src/server.rs`, `crates/mdview/src/views.rs`, `crates/mdview/src/herdr/`, `crates/mdview/src/supervisor.rs`, `crates/mdview/src/notify/`, `crates/mdview-core/src/config.rs`, `crates/mdview-core/src/transcript.rs`, `crates/mdview-core/src/paths_boundary.rs`, `crates/mdview-core/src/notify_store.rs`, `crates/mdview-core/src/ansi.rs` |
