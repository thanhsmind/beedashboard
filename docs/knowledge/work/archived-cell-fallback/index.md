...
# work/archived-cell-fallback/

## Concepts

- [archived-cell-fallback — delivery](delivery.md) — Delivery record for work item archived-cell-fallback: 1 capped cell(s), 0 recorded deviation(s).
