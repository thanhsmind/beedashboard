...
# work/homepage-terminals/

## Concepts

- [homepage-terminals — delivery](delivery.md) — Delivery record for work item homepage-terminals: 2 capped cell(s), 2 recorded deviation(s).
