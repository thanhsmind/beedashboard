...
# work/projects-tab-ordering/

## Concepts

- [projects-tab-ordering — delivery](delivery.md) — Projects tab drops its page heading and floats agent-active project groups above idle ones.
