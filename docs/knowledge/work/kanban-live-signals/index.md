...
# work/kanban-live-signals/

## Concepts

- [kanban-live-signals — delivery](delivery.md) — Delivery record for work item kanban-live-signals: 2 capped cell(s), 0 recorded deviation(s).
