...
# work/home-terminal-parity/

## Concepts

- [home-terminal-parity — delivery](delivery.md) — Delivery record for work item home-terminal-parity: 2 capped cell(s), 0 recorded deviation(s).
