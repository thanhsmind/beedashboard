...
# work/terminals-pane-select/

## Concepts

- [terminals-pane-select — delivery](delivery.md) — Delivery record for work item terminals-pane-select: the Terminals tab's pane switcher became a single select.
